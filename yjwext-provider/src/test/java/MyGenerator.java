...
public class MyGenerator {
    ...
    public static void main(String[] args) {
        ...
        gc.setOutputDir(projectPath + "/yjwext-provider/src/main/java");
        gc.setAuthor("jackLiu");
        gc.setOpen(false);
        mpg.setGlobalConfig(gc);

        // 数据源配置
        DataSourceConfig dsc = new DataSourceConfig();
        dsc.setUrl("jdbc:mysql://localhost:3306/yjwext?useUnicode=true&useSSL=false&characterEncoding=utf8");
        ...
        focList.add(new FileOutConfig(templatePath) {
            ...
            public String outputFile(TableInfo tableInfo) {
                ...
                return projectPath + "/yjwext-provider/src/main/resources/mapper/" + pc.getModuleName()
